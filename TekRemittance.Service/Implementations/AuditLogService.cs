...
namespace TekRemittance.Service.Implementations
{
    public class AuditLogService : IAuditLogService
    {
        ...
        public async Task<PagedResult<AuditLogDTO>> GetAllAuditLogs(int pageNumber = 1, int pageSize = 10, string? search = null)
        {
            return await _repository.GetAllAuditLogsAsync(pageNumber, pageSize,search);
        }
    }
}
