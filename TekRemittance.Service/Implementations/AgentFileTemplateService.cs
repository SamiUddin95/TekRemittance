...
namespace TekRemittance.Service.Implementations
{
    public class AgentFileTemplateService : IAgentFileTemplateService
    {
        ...
        public Task<PagedResult<object>> GetDataByUploadIdAsync(Guid UploadId, int pageNumber = 1, int pageSize = 50) => _repo.GetDataByUploadIdAsync(UploadId, pageNumber, pageSize);
