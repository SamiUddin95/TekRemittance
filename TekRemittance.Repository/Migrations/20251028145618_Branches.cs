        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentBranchName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ...
                    AcquisitionModes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    DisbursementModes = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Branches_AcquisitionAgents_AgentId",
                        column: x => x.AgentId,
